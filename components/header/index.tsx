...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-field-border bg-field-bg/85 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-lg tracking-tight text-ball-white group-hover:text-pitch-hover transition-colors font-brand">
        ...
        {/* Authentication Navigation (Client Component) */}
